...
class CustomBasicDateTime(DateTimeTypeConversion):
    ...
    def __init__(self, type_str=True, type_time=False, this_time=None):
        """
    ...
    def time_type(self, date_time=None):
        """
        return
    ...
    #  =============================== 年月日周前后 ===============================
    def before_after_year(self, year_len):
        """
        前几年   后几年
        -N       N
        """
    ...
    def before_after_month(self, month_len):
        """
        前几月   后几月
        -N       N
        """
...
if __name__ == '__main__':
    # t = CustomBasicDateTime().time_type()
    # print(t)
    # print(CustomBasicDateTime(this_time=t).before_after_month(-1))
    cbt = CustomBasicDateTime()
    time_new = cbt.time_type()
    year_list = [cbt.before_after_year(-5 * i) for i in range(1, 4)]
    print(year_list)